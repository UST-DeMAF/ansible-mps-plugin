...
public class Play {
    ...
    public Play(String name, HashSet<Host> hosts, HashSet<Task> preTasks, HashSet<Task> tasks, HashSet<Task> postTasks, HashSet<Role> roles, HashSet<Variable> vars, Boolean become) {
        this.name = name;
        this.hosts = hosts;
    ...
    public boolean equals(Object o) {
        ...
        Play play = (Play) o;
        return Objects.equals(name, play.name) && Objects.equals(hosts, play.hosts) && Objects.equals(preTasks, play.preTasks)
        && Objects.equals(tasks, play.tasks) && Objects.equals(postTasks, play.postTasks) && Objects.equals(roles, play.roles)
                && Objects.equals(vars, play.vars) && Objects.equals(become, play.become);
    }
