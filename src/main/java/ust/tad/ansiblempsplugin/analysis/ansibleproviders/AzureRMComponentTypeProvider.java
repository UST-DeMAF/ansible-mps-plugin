...
public class AzureRMComponentTypeProvider {
    ...
    public static List<Property> createPropertiesForDefaultOperatingSystem() throws InvalidPropertyValueException {
        List<Property> properties = new ArrayList<>();
    ...
    public static List<Property> getPropertiesForVMSize(String vmSize) throws InvalidPropertyValueException {
        List<Property> properties = new ArrayList<>();
